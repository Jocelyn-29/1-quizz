...
form.addEventListener('submit', (e) => {
    ...
    // console.log(document.querySelector('input[name="q1"]:checked').value);selectionne le radio coché à faire pour les cinq question avec boucle for on met les resultats dans le tableauResultast avec push
    ...
    tableauResultats = []; //le tableau est vidé à chaque nouvelle initialisation
})
